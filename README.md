...
**Доступ к приложению:**
- **Web (браузер)**: `http://localhost:18080` - использует веб-маршруты через Inertia.js
...
- **[DOCKER_FLUTTER_SETUP.md](DOCKER_FLUTTER_SETUP.md)** - Настройка Flutter с Docker
- **[QUICK_START_DOCKER.md](QUICK_START_DOCKER.md)** - Быстрый старт с Docker
- **[docs/API_DOCUMENTATION.md](docs/API_DOCUMENTATION.md)** - Документация API
- **[docs/MOBILE_API_EXAMPLE.md](docs/MOBILE_API_EXAMPLE.md)** - Примеры использования API

> **Примечание**: Документация по функциям приложения находится в папке `docs/`
