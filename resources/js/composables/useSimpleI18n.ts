...
const fallbackTranslations = {
  ...
  en: {
    ...
    'metronome.autoIncrement': 'Auto-Increment Tempo',
    'metronome.intervalSeconds': 'Interval (sec)',
    'metronome.incrementAmount': 'BPM Increment',
    'metronome.useTargetBpm': 'Target Tempo',
