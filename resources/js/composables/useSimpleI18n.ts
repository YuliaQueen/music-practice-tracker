...
const fallbackTranslations = {
  ru: {
    ...
    'metronome.subdivision': 'Дробление',
    'metronome.subdivisions.none': 'Нет',
    'metronome.subdivisions.eighth': '8-е',
    'metronome.subdivisions.triplet': 'Триоль',
    'metronome.subdivisions.sixteenth': '16-е',
    'metronome.countIn': 'Вступительный отсчёт',
    'metronome.countingIn': 'Отсчёт...',
    'metronome.countInOptions.off': 'Выкл',
    'metronome.countInOptions.onebar': '1 такт',
    'metronome.countInOptions.twobars': '2 такта',
    'metronome.countInOptions.fourbars': '4 такта',
    'metronome.muteMode': 'Режим заглушения (тренировка без звука)',
    'metronome.muted': 'Заглушено',
    'metronome.playBars': 'Такты со звуком',
    'metronome.muteBars': 'Такты без звука',
    'metronome.tempoPresets': 'Темповые пресеты',
    'metronome.presets.largo': 'Ларго',
    'metronome.presets.adagio': 'Адажио',
    'metronome.presets.andante': 'Анданте',
    'metronome.presets.moderato': 'Модерато',
    'metronome.presets.allegro': 'Аллегро',
    'metronome.presets.presto': 'Престо',
    'metronome.autoIncrement': 'Авто-увеличение темпа',
    'metronome.intervalSeconds': 'Интервал (сек)',
    'metronome.incrementAmount': 'Прирост (+BPM)',
    'metronome.useTargetBpm': 'Использовать целевой темп',
    'metronome.targetBpm': 'Целевой темп',
    'metronome.nextIncrementIn': 'Следующее увеличение через',
    'metronome.speedTrainer': 'Скоростной тренажёр (прогрессивный темп)',
    'metronome.startBpm': 'Начальный темп',
    'metronome.endBpm': 'Конечный темп',
    'metronome.stepSize': 'Шаг увеличения',
    'metronome.barsPerTempo': 'Тактов/темп',
    'metronome.cycleBack': 'Вернуться к началу',
    'metronome.barsRemaining': 'Осталось тактов',
    'metronome.currentTempo': 'Текущий темп',
  ...
  en: {
    ...
    'metronome.subdivisions.none': 'None',
    'metronome.subdivisions.eighth': '8th',
    'metronome.subdivisions.triplet': 'Triplet',
    'metronome.subdivisions.sixteenth': '16th',
    'metronome.countIn': 'Count-In',
    'metronome.countingIn': 'Counting in...',
    'metronome.countInOptions.off': 'Off',
    'metronome.countInOptions.onebar': '1 bar',
    'metronome.countInOptions.twobars': '2 bars',
    'metronome.countInOptions.fourbars': '4 bars',
    'metronome.muteMode': 'Mute Mode (Silent Bars Training)',
    'metronome.muted': 'Muted',
    'metronome.playBars': 'Play Bars',
    'metronome.muteBars': 'Mute Bars',
    'metronome.tempoPresets': 'Tempo Presets',
    'metronome.presets.largo': 'Largo',
    'metronome.presets.adagio': 'Adagio',
    'metronome.presets.andante': 'Andante',
    'metronome.presets.moderato': 'Moderato',
    'metronome.presets.allegro': 'Allegro',
    'metronome.presets.presto': 'Presto',
    'metronome.autoIncrement': 'Auto-Increment BPM',
    'metronome.intervalSeconds': 'Interval (sec)',
    'metronome.incrementAmount': 'Increment (+BPM)',
    'metronome.useTargetBpm': 'Use Target BPM',
    'metronome.targetBpm': 'Target BPM',
    'metronome.nextIncrementIn': 'Next increment in',
    'metronome.speedTrainer': 'Speed Trainer (Progressive Tempo)',
    'metronome.startBpm': 'Start BPM',
    'metronome.endBpm': 'End BPM',
    'metronome.stepSize': 'Step Size',
    'metronome.barsPerTempo': 'Bars/Tempo',
    'metronome.cycleBack': 'Cycle back to start',
    'metronome.barsRemaining': 'Bars remaining',
    'metronome.currentTempo': 'Current tempo',
